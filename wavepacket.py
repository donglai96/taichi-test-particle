...
class Wave:
    ...
    @ti.func
    def initialize(self, w, L, n0, Bw0, phi0, lat_max):
        self.w = w
        self.L = L 
        self.n0 = n0
    ...
    def get_field(self, r, t, phi_z):
        ...
        self.B_back = dipole_field(self.L, [0,0,lat], cst.B0)
        ...
        if lat < self.lat_max:
            self.Bw = [self.Bw0 * cosp,  - self.Bw0 * sinp, 0.0]

            Ew = self.Bw0 / (cst.C * self.k / self.w)
